...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="Gv_Personas" CssClass="table table-striped table-hover table-success" runat="server" AutoGenerateColumns="False" 
        DataSourceID="SqlDataSource" DatakeyNames="ID" OnRowDeleting="Gv_Personas_RowDeleting" OnRowEditing="Gv_Personas_RowEditing" OnRowCancelingEdit="Gv_Personas_RowCancelingEdit" OnRowUpdating="Gv_Personas_RowUpdating">
        >
        <Columns>
